...
typedef struct
{
    ...
    wchar_t *kill_ring;		/* The kill ring.  */
...
extern void il_init PROTO ((void));
extern void il_end PROTO ((void));
extern void il_free PROTO ((input_line_t *));
extern void il_resize PROTO ((int, int));
extern input_line_t *il_save PROTO ((void));
extern void il_restore PROTO ((input_line_t *));
extern size_t il_point PROTO ((void));
extern int il_echo PROTO ((int));
extern int il_is_empty PROTO ((void));
extern void il_set_mark PROTO ((void));
extern void il_kill_region PROTO ((void));
extern void il_kill_ring_save PROTO ((void));
extern void il_yank PROTO ((void));
extern void il_exchange_point_and_mark PROTO ((void));
extern void il_backward_char PROTO ((void));
extern void il_forward_char PROTO ((void));
extern void il_backward_word PROTO ((void));
extern void il_forward_word PROTO ((void));
extern void il_beginning_of_line PROTO ((void));
extern void il_end_of_line PROTO ((void));
extern void il_insert_char PROTO ((wchar_t));
extern void il_delete_char PROTO ((void));
extern void il_backward_delete_char PROTO ((void));
extern void il_kill_word PROTO ((void));
extern void il_backward_kill_word PROTO ((void));
extern void il_reset_line PROTO ((void));
extern void il_kill_line PROTO ((int));
extern void il_kill_to_beginning_of_line PROTO ((void));
extern void il_kill_to_end_of_line PROTO ((void));
extern void il_just_one_space PROTO ((void));
extern void il_delete_horizontal_space PROTO ((void));
extern void il_downcase_word PROTO ((void));
extern void il_upcase_word PROTO ((void));
extern void il_capitalize_word PROTO ((void));
